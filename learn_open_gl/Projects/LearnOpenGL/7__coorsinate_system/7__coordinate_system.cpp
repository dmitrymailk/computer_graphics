...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float some = (float)glfwGetTime() ; // - 55.0f
		model = glm::rotate(model, glm::radians(some * 10), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(some* 500), glm::vec3(0.0f, 1.0f, 0.0f));
